...
initSiteBaseInfo();
useHead({
  title: "搜索 "+ dataInfo.searchText + " - " + dataInfo.siteInfo.site_name + " --第" +dataInfo.pageInfo.current+"页",
  meta: [
    { property: 'og:title', content: "搜索 " + dataInfo.searchText + " - " + dataInfo.siteInfo.site_name + " --第" +dataInfo.pageInfo.current+"页" },
  ],
...
if (error.value!=null) {
  ...
  console.log("dd  dataInfo.pageInfo.pages ", dataInfo.pageInfo )
}
