        ...
        <a-row  class="footer-copy" justify="center" align="middle">
          <a-col  > ©
            <template v-if="siteInfo.site_open_date">
              {{moment(siteInfo.site_open_date).year()}} -
            </template>
            {{moment().year()}}&nbsp;&nbsp;&nbsp;&nbsp;<a :href="siteInfo.site_url" :title="siteInfo.site_name" rel="link noopener" target="_blank" v-if="siteInfo.site_url">{{siteInfo.site_name}}</a>
            <router-link  to="/"  :title="siteInfo.site_name" rel="link noopener" target="_blank"  v-else > {{siteInfo.site_name}}</router-link >&nbsp;&nbsp;
          </a-col>
